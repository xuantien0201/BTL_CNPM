                ...
                <div class="card">
                    <div class="card-content">
                        <form method="post">
                            ...
                            <div class="row">
                                <div class="input-field col s6">
                                    <input id="LinhVuc" name="LinhVuc" type="hidden" value="<?= htmlentities($result->LinhVuc) ?>">
                                    <input id="LinhVuc" name="LinhVuc" type="text" value="<?= htmlentities($result->LinhVuc) ?>" disabled required>
        ...
        <input id="NgayKetThuc" name="NgayKetThuc" type="date" value="<?= date('Y-m-d', strtotime($result->NgayKetThuc)) ?>" required>
                            ...
                            <div class="row">
                                <div class="input-field col s12">
                                    <textarea id="MoTa" name="MoTa" class="materialize-textarea" ><?= htmlentities($result->MoTa) ?></textarea>
