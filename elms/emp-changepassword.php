...
if(isset($_POST['change']))
    ...
    $sql ="SELECT * FROM tblgiangvien WHERE email_giangvien=:username and mk_giangvien=:password";
    ...
    if($query -> rowCount() > 0)
    {
    $con="UPDATE tblgiangvien SET mk_giangvien=:newpassword where email_giangvien=:username";
...
<html lang="en">
    <head>
        ...
        <!-- Title -->
        <title>Employee | Đổi mật khẩu</title>
...
<div class="input-field col s12">
<button type="submit" name="change" class="waves-effect waves-light btn indigo m-b-xs" onclick="return valid();">Thay đổi</button>
